...
const ServiceSection = ({ title, children, image }) => {
  return (
    <div className="grid grid-rows-2 gap-y-6 mx-4 min-h-[700px] max-h-[700px] sm:max-h-[600px] md:grid-cols-2 md:grid-rows-1 md:mx-10 md:min-h-[350px] md:max-w-[1200px] lg:min-h-0 lg:mx-16 xl:mx-12 2xl:mx-24 overflow-hidden">
