...
const ServiceSectionReverse = ({ id, title, children, image }) => {
  return (
    <div id={id} className="grid grid-rows-2 gap-y-6 mx-4 min-h-[700px] max-h-[700px] md:grid-cols-2 sm:max-h-[600px] md:grid-rows-1 md:my-0 md:mx-10 md:min-h-[350px] lg:min-h-0 lg:mx-16 xl:mx-12 2xl:mx-24 xl:max-h-[400px] md:max-w-[1200px] overflow-hidden">
