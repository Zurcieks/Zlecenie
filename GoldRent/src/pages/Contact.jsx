...
const Contact = () => {
  ...
  return (
    <div className='relative bg-cover bg-center z-0 h-screen' style={{ backgroundImage: "url(/obrazek1.jpg)" }}>
      <div className='relative z-10 xl:container mx-auto mb-32'>
        <div className='flex justify-center' style={{ height: '250px' }}>
          <h1 className='text-4xl sm:text-4xl md:m-auto md:-mt-1 font-bold font-sans text-black pt-12'>
            Skontaktuj się z nami
          </h1>
        </div>
        <div className='px-4 sm:w-2/3 lg:w-1/2 mx-auto opacity-95'>
