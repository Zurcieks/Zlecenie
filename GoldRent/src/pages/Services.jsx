  ...
  return (
    <div>
      ...
      <div className="flex flex-col justify-center items-center my-24 md:space-y-0">
        ...
        <ServiceSection id={3} title="Najem długoterminowy" image={obrazek5}>
        ...
        <ServiceSectionReverse id={4} title="Najem krótkoterminowy" image={obrazek6}>
        ...
        <ServiceSection id={5} title="Wynajem pojedynczych pokoi" image={obrazek7}>
